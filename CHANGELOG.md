...
- Pod diagnostic capture and sanitization share one canonical artifact-name helper, preventing DNS evidence suffix drift while retaining fail-closed cleanup ordering.
